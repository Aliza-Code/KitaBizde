...
namespace KitaBizde.DataLayer.Migrations
{
    ...
    [Migration("20240717084437_InitialDataBase")]
            ...
            modelBuilder.Entity("KitaBizde.DataLayer.Entities.Book.Books", b =>
                {
                    ...
                    b.Property<int?>("BookLevelLevelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KitaBizde.DataLayer.Entities.Book.Books", b =>
                {
                    ...
                    b.HasOne("KitaBizde.DataLayer.Entities.Book.BookLevel", null)
                        .WithMany("Books")
                        .HasForeignKey("BookLevelLevelId");
