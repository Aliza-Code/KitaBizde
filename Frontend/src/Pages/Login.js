...
export default function Login() {
  ...
  return (
    <>
      ...
      <section className="mt-6 mb-12 flex items-center justify-center">
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          <div className="md:w-1/2 px-8 md:px-16">
            <h2 className="font-bold text-2xl text-sky-900">صفحه ورود</h2>
            <p className="text-xs mt-4 text-sky-900">وارد صفحه خود شوید.</p>

            <form onSubmit={subForm} className="flex flex-col gap-4">
              <input
                className="p-2 rounded-md outline-none placeholder:text-sm mt-8"
          ...
          <div className="md:block hidden w-1/2">
            <img className="rounded-2xl" src={loginBG}></img>
          </div>
        </div>
      </section>
